...
const uint8_t SmlParser::SEQ_CONSUMED1[8] = { 0x77, 0x07, 0x01, 0x00, 0x01, 0x08, 0x00, 0xFF };
const uint8_t SmlParser::SEQ_PRODUCED1[8] = { 0x77, 0x07, 0x01, 0x00, 0x02, 0x08, 0x00, 0xFF };
const uint8_t SmlParser::SEQ_CONSUMED2[8] = { 0x77, 0x07, 0x01, 0x00, 0x01, 0x08, 0x01, 0xFF };
const uint8_t SmlParser::SEQ_PRODUCED2[8] = { 0x77, 0x07, 0x01, 0x00, 0x02, 0x08, 0x01, 0xFF };
